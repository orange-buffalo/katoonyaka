...
<html>
    <head>
        <title>Katoonyaka. ${handiwork.name}</title>
        <#include "head-common.ftl"/>
        <link rel="stylesheet" href="/static/css/katoonyaka-details.${katoonyakaVersion}.css">
    </head>
    <body>
      <div>
    <#include "nav-bar.ftl"/>
      ...
      <script type="text/javascript">
         var mainJs = "/static/js/katoonyaka.details-${katoonyakaVersion}.min.js";
      </script>
